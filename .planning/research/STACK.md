...
**Confidence:** HIGH (core stack verified via multiple current sources)
...
```bash
# Bootstrap
npx create-next-app@latest vuoroasuminen --typescript --tailwind --app --src-dir --import-alias "@/*"

# Auth and database
npm install next-auth@beta @auth/drizzle-adapter drizzle-orm pg
...
npx shadcn@canary init   # uses Tailwind v4 path
```
...
**For real-time cell updates (the core feature):**
...
**For Google Calendar sync (draft → publish):**
...
---
*Stack research for: Vuoroasuminen — co-parenting custody scheduling web app*
*Researched: 2026-04-04*
